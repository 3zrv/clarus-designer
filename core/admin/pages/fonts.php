...
<div class="lumise_wrapper">
	...
	<div class="lumise_content">
		...
		<div class="lumise_header">
			...
			<a href="<?php echo $lumise->cfg->admin_url;?>lumise-page=font" class="add-new lumise-button">
		...
		<div class="lumise_option">
			<div class="left">
				<form action="<?php echo $lumise->cfg->admin_url;?>lumise-page=fonts" method="post">
							...
							if ( is_array($fonts['rows']) && count($fonts['rows']) > 0 ) {
								...
								foreach ($fonts['rows'] as $value) { ?>
									...
									<tr>
										...
										<td>
											<a href="<?php
												echo $lumise->cfg->admin_url;?>lumise-page=font&id=<?php
		...
		<?php } else {
					if (isset($total_record) && $total_record > 0) {
						...
						$_SESSION[$prefix.'data_search'] = '';
						echo '<a href="'.$lumise->cfg->admin_url.'lumise-page=fonts" class="btn-back"><i class="fa fa-reply" aria-hidden="true"></i>'.$lumise->lang('Back To Lists').'</a>';
					}
					else
